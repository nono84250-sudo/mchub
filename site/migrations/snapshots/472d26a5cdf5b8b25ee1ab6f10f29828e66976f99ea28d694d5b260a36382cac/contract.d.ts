...
export type StorageHash =
  StorageHashBase<'472d26a5cdf5b8b25ee1ab6f10f29828e66976f99ea28d694d5b260a36382cac'>;
export type ExecutionHash =
  ExecutionHashBase<'8896e154d9743fcde5e333f54c07d991d348862a0417251a64007c34e5810f4a'>;
...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly Notification: {
      ...
      readonly type: 'report_replied' | 'report_resolved';
      readonly serverName: CodecTypes['pg/text@1']['output'];
    ...
    readonly Server: {
      ...
      readonly modpackSource: 'curseforge' | 'modrinth';
...
export type FieldInputTypes = {
  readonly public: {
    ...
    readonly Notification: {
      ...
      readonly type: 'report_replied' | 'report_resolved';
      readonly serverName: CodecTypes['pg/text@1']['input'];
...
export namespace Models {
  ...
  export type public_Server = {
    ...
    modpackSource: 'curseforge' | 'modrinth';
  ...
  export type public_Notification = {
    id: CodecTypes['pg/text@1']['output'];
    recipientMinecraftUuid: CodecTypes['pg/text@1']['output'];
    type: 'report_replied' | 'report_resolved';
    serverName: CodecTypes['pg/text@1']['output'];
      ...
      readonly public: {
        ...
        readonly entries: {
          readonly table: {
            ...
            readonly notification: {
              columns: {
                ...
                readonly recipientMinecraftUuid: {
                  readonly nativeType: 'text';
                  readonly codecId: 'pg/text@1';
                  readonly nullable: false;
                };
              ...
              indexes: readonly [
                {
                  readonly name: 'notification_recipientMinecraftUuid_read_createdAt_idx_7f5b47c2';
                  readonly prefix: 'notification_recipientMinecraftUuid_read_createdAt_idx';
                  readonly columns: readonly ['recipientMinecraftUuid', 'read', 'createdAt'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [];
            ...
            readonly server: {
              columns: {
                ...
                readonly modpackSource: {
                  readonly nativeType: 'text';
                  readonly codecId: 'pg/text@1';
                  readonly nullable: false;
                  readonly default: {
                    readonly kind: 'literal';
                    readonly value: DefaultLiteralValue<'pg/text@1', 'curseforge'>;
                  };
                };
          ...
          readonly valueSet: {
            ...
            readonly modpack_source: {
              readonly kind: 'valueSet';
              readonly values: readonly ['curseforge', 'modrinth'];
            };
            readonly notification_type: {
              readonly kind: 'valueSet';
              readonly values: readonly ['report_replied', 'report_resolved'];
            };
      ...
      readonly public: {
        readonly models: {
          ...
          readonly Notification: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                readonly id: { readonly column: 'id' };
                readonly recipientMinecraftUuid: { readonly column: 'recipientMinecraftUuid' };
          ...
          readonly Server: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly modpackSource: { readonly column: 'modpackSource' };
        ...
        readonly enum: {
          ...
          readonly modpack_source: {
            readonly codecId: 'pg/text@1';
            readonly members: readonly [
              { readonly name: 'curseforge'; readonly value: 'curseforge' },
              { readonly name: 'modrinth'; readonly value: 'modrinth' },
            ];
          };
          readonly server_event_kind: {
            readonly codecId: 'pg/text@1';
          ...
          readonly notification_type: {
            readonly codecId: 'pg/text@1';
            readonly members: readonly [
              { readonly name: 'report_replied'; readonly value: 'report_replied' },
