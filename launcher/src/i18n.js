...
const DICTIONARIES = {
  fr: {
    ...
    report: {
      ...
      subtitle: "Décris le problème technique que tu rencontres — c'est envoyé directement au propriétaire du serveur.",
      issueLabel: "Problème",
      issueCantConnect: "Impossible de se connecter",
      issueWrongVersion: "Mauvaise version",
      issueModpackDownload: "Le modpack ne se télécharge pas",
      issueCrash: "Plantage au lancement",
      issueOther: "Autre",
      messageLabel: "Décris ce qu'il s'est passé",
      attachDiagnostics: "Joindre les diagnostics",
      send: "Envoyer",
      sending: "Envoi…",
      sent: "Signalement envoyé — merci !",
      missingFields: "Choisis un type de problème et décris-le avant d'envoyer.",
      failed: "Envoi impossible — réessaie dans un instant.",
    },
    notifications: {
      reportRepliedTitle: "Réponse à ton signalement — {server}",
      reportResolvedTitle: "{server} : ton problème a été marqué comme résolu",
      justNow: "à l'instant",
      ...
      deleteOne: "Supprimer cette notification",
    },
    favorites: {
    ...
    myInstances: {
      ...
      published: "Publié",
      paused: "En pause",
      subtitle: "Tous les serveurs que tu as créés — publiés ou non.",
      newInstance: "Nouvelle instance",
      manageNote: "\"Gérer\" ouvre la console sur le site",
      filterAll: "Tout",
      filterPublic: "Public",
      filterPrivate: "Privé",
      ...
      hiddenNote: "Masqué de l'annuaire jusqu'à republication",
      filterEmpty: "Aucun serveur dans cette catégorie.",
    },
    settings: {
      title: "Paramètres",
  ...
  en: {
    ...
    report: {
      ...
      subtitle: "Describe the technical problem you're having — this goes straight to the server owner.",
      issueLabel: "Issue",
      issueCantConnect: "Can't connect",
      issueWrongVersion: "Wrong version",
      issueModpackDownload: "Modpack won't download",
      issueCrash: "Crash on launch",
      issueOther: "Other",
      ...
      missingFields: "Pick an issue type and describe it before sending.",
      failed: "Couldn't send — try again in a moment.",
    },
    notifications: {
      reportRepliedTitle: "Reply to your report — {server}",
      reportResolvedTitle: "{server}: your issue was marked resolved",
      justNow: "just now",
    ...
    myInstances: {
      ...
      published: "Published",
      paused: "Paused",
      subtitle: "Every server you created — published or not.",
      newInstance: "New instance",
      manageNote: "\"Manage\" opens the console on the website",
      filterAll: "All",
      filterPublic: "Public",
      ...
      hiddenNote: "Hidden from the directory until you republish",
      filterEmpty: "No server in this category.",
    },
    settings: {
      title: "Settings",
