...
const DICTIONARIES = {
  fr: {
    ...
    java: {
      ...
      tooOld: "Java {version} détecté, mais Minecraft a besoin de Java 21 ou plus récent.",
    ...
    debug: {
      ...
      logLevelDesc: "Quantité de détail écrite dans le fichier de log.",
      logLevelError: "Erreur",
      logLevelWarn: "Avertissement",
      logLevelInfo: "Info",
      logLevelDebug: "Debug",
      openOnLaunch: "Ouvrir la console au lancement du jeu",
      openOnLaunchDesc: "Ouvre la console automatiquement à chaque clic sur Jouer.",
      keepOpen: "Garder le launcher ouvert pendant la partie",
      keepOpenDesc: "Pratique pour surveiller les erreurs en direct.",
      logsSection: "Journaux et rapports",
      logFiles: "Fichiers de log",
      openLogsFolder: "Ouvrir le dossier des logs",
      copyLatestLog: "Copier le dernier log",
      copied: "Copié dans le presse-papiers.",
      diagnosticReport: "Rapport de diagnostic",
      diagnosticReportDesc: "Rassemble logs et infos système dans un seul fichier.",
      exportReport: "Exporter le rapport",
      reportExported: "Rapport exporté et ouvert dans l'explorateur.",
      systemSection: "Infos système",
      copyToClipboard: "Copier dans le presse-papiers",
      labelElectron: "Electron",
      labelOs: "OS",
      labelJava: "Java",
      labelGpu: "GPU",
      javaNotDetected: "Non détecté",
      gpuUnknown: "Inconnu",
      resetSection: "Réinitialisation et réparation",
      repairFiles: "Réparer les fichiers du jeu",
      repairFilesDesc: "Revérifie et retélécharge les fichiers manquants ou corrompus.",
      repair: "Réparer",
      repaired: "Fichiers réparés — seront retéléchargés au prochain lancement.",
      unitGB: "Go",
      unitMB: "Mo",
      clearCache: "Vider le cache",
      clearCacheDesc: "Supprime les assets et téléchargements en cache · {size}.",
      clearCacheConfirm: "Vider le cache ? Les assets seront retéléchargés au prochain lancement.",
      cacheCleared: "Cache vidé.",
      resetSettings: "Réinitialiser les paramètres",
      resetSettingsDesc: "Restaure les valeurs par défaut. Compte et fichiers du jeu conservés.",
      reset: "Réinitialiser",
      resetConfirm: "Réinitialiser tous les paramètres du launcher ?",
  ...
  en: {
    ...
    java: {
      ...
      tooOld: "Java {version} detected, but Minecraft needs Java 21 or newer.",
    ...
    debug: {
      ...
      logLevel: "Log level",
      logLevelDesc: "How much detail is written to the log file.",
      logLevelError: "Error",
      logLevelWarn: "Warn",
      logLevelInfo: "Info",
      logLevelDebug: "Debug",
      openOnLaunch: "Open console on game launch",
      openOnLaunchDesc: "Opens the console automatically each time you press Play.",
      keepOpen: "Keep launcher open while playing",
      keepOpenDesc: "Useful to watch errors in real time.",
      logsSection: "Logs & reports",
      logFiles: "Log files",
      openLogsFolder: "Open logs folder",
      copyLatestLog: "Copy latest log",
      copied: "Copied to clipboard.",
      diagnosticReport: "Diagnostic report",
      diagnosticReportDesc: "Bundles logs and system info into one file.",
      exportReport: "Export report",
      reportExported: "Report exported and opened in your file explorer.",
      ...
      gpuUnknown: "Unknown",
      resetSection: "Reset & repair",
      repairFiles: "Repair game files",
      repairFilesDesc: "Re-verifies and re-downloads missing or corrupted files.",
      repair: "Repair",
      repaired: "Files repaired — will be re-downloaded on next launch.",
      unitGB: "GB",
      unitMB: "MB",
      clearCache: "Clear cache",
      clearCacheDesc: "Removes cached assets and downloads · {size}.",
      clearCacheConfirm: "Clear cache? Assets will be re-downloaded on next launch.",
      cacheCleared: "Cache cleared.",
      resetSettings: "Reset launcher settings",
      resetSettingsDesc: "Restores defaults. Your account and game files are kept.",
      reset: "Reset",
      resetConfirm: "Reset all launcher settings?",
